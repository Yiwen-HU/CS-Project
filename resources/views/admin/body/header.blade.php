<nav class="navbar">
              ...
              <div class="input-group-text">
                ...
                <a href="javascript:;" class="dropdown-item py-2"><i class="flag-icon flag-icon-cn" title="fr" id="fr"></i> <span class="ms-1"> Chinese </span></a>
                <a href="javascript:;" class="dropdown-item py-2"><i class="flag-icon flag-icon-jp" title="de" id="de"></i> <span class="ms-1"> Japanes </span></a>
